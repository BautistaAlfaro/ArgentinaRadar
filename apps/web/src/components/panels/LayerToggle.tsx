...
const LAYER_DEFINITIONS: { id: LayerId; label: string; description: string }[] = [
  { id: 'provinces', label: 'Provincias', description: 'L├¡mites provinciales' },
  { id: 'borders', label: 'Pa├¡ses', description: 'Fronteras de Sudam├⌐rica y Ant├írtida Argentina' },
  ...
  { id: 'weather', label: 'Clima', description: 'Alertas meteorol├│gicas' },
  ...
  { id: 'economic', label: 'Econ├│mico', description: 'Indicadores econ├│micos' },
  ...
  { id: 'flights', label: 'Vuelos', description: 'Tr├ífico a├⌐reo en vivo' },
  { id: 'security', label: 'Inseguridad', description: 'Estad├¡sticas de seguridad por provincia' },
  { id: 'protests', label: 'Protestas ≡ƒÜº', description: 'Cortes y manifestaciones activos' },
];
      ...
      <div className="mt-6 pt-4 border-t border-slate-700/50">
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex items-center gap-2 text-xs text-slate-500">
            ...
            <span>Ant├írtida Argentina (reclamo)</span>
          </div>
          <div className="flex items-center gap-2 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-2 text-xs text-slate-500">
            ...
            <span>Sismo M3ΓÇô4.9</span>
          </div>
          <div className="flex items-center gap-2 text-xs text-slate-500">
            <span className="inline-block w-3 h-3 rounded-full bg-amber-400" />
            <span>Sismo M5ΓÇô6.9</span>
          </div>
          <div className="flex items-center gap-2 text-xs text-slate-500">
